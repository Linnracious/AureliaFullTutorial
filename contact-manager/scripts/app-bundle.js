...
define('contact-detail',['exports', 'aurelia-framework', 'aurelia-event-aggregator', './web-api', './message', './utility'], function (exports, _aureliaFramework, _aureliaEventAggregator, _webApi, _message, _utility) {
    'use strict';
    ...
    var ContactDetail = exports.ContactDetail = (_dec = (0, _aureliaFramework.inject)(_webApi.WebAPI, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
        ...
        ContactDetail.prototype.activate = function activate(params, routeConfig) {
            ...
            return this.api.getContactDetails(params.id).then(function (contact) {
                ...
                _this.ea.publish(new _message.ContactViewed(_this.contact));
            });
        };
        ...
        ContactDetail.prototype.save = function save() {
            ...
            this.api.saveContact(this.contact).then(function (contact) {
                ...
                _this2.ea.publish(new _message.ContactUpdated(_this2.contact));
            });
        };
        ...
        ContactDetail.prototype.canDeactivate = function canDeactivate() {
            if (!(0, _utility.areEqual)(this.originalContact, this.contact)) {
                ...
                if (!result) {
                    this.ea.publish(new _message.ContactViewed(this.contact));
                }
...
define('contact-list',['exports', 'aurelia-event-aggregator', './web-api', './message', 'aurelia-framework'], function (exports, _aureliaEventAggregator, _webApi, _message, _aureliaFramework) {
    'use strict';
    ...
    var ContactList = exports.ContactList = (_dec = (0, _aureliaFramework.inject)(_webApi.WebAPI, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
        function ContactList(api, ea) {
            ...
            ea.subscribe(_message.ContactViewed, function (msg) {
                return _this.select(msg.contact);
            });
            ea.subscribe(_message.ContactUpdated, function (msg) {
